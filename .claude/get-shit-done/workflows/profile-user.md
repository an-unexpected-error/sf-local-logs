...
Key references:
- @/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/mc/Repos/sf-local-logs/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/USER-PROFILE.md" "/Users/mc/Repos/sf-local-logs/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/mc/Repos/sf-local-logs/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/mc/Repos/sf-local-logs/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/mc/Repos/sf-local-logs/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/mc/Repos/sf-local-logs/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/mc/Repos/sf-local-logs/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/mc/Repos/sf-local-logs/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/mc/Repos/sf-local-logs/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/mc/Repos/sf-local-logs/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/mc/Repos/sf-local-logs/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /Users/mc/Repos/sf-local-logs/.claude/CLAUDE.md
```
