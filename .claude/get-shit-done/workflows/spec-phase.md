...
```bash
INIT=$(node "/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/templates/spec.md.
