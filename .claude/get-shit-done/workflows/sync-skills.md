...
INSTALL_JS_GLOBAL="/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/mc/Repos/sf-local-logs/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
