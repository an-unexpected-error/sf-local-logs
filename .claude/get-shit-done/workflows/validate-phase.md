...
```
Agent(
  prompt="Read /Users/mc/Repos/sf-local-logs/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/templates/VALIDATION.md`
