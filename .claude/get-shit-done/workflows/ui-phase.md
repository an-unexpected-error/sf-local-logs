...
```markdown
Read /Users/mc/Repos/sf-local-logs/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/mc/Repos/sf-local-logs/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/mc/Repos/sf-local-logs/.claude/agents/gsd-ui-checker.md for instructions.
