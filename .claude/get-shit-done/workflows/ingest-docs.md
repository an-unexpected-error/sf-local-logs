...
```bash
INIT=$(node "/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
