...
<required_reading>
@/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/mc/Repos/sf-local-logs/.claude
                  → checks /Users/mc/Repos/sf-local-logs/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/mc/Repos/sf-local-logs/.claude/get-shit-done
                  → writes to /Users/mc/Repos/sf-local-logs/.claude/get-shit-done/hooks/
...
@/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/references/common-bug-patterns.md
