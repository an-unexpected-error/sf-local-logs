...
<reference>
@/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/references/user-profiling.md` to load:
