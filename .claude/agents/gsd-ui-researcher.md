...
Use template from `/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/templates/UI-SPEC.md`
