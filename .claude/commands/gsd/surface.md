...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/mc/Repos/sf-local-logs/.claude/.gsd-surface.json`
(sibling to `/Users/mc/Repos/sf-local-logs/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/mc/Repos/sf-local-logs/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/mc/Repos/sf-local-logs/.claude/skills`).
...
`/Users/mc/Repos/sf-local-logs/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/mc/Repos/sf-local-logs/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/mc/Repos/sf-local-logs/.claude/.gsd-surface.json`
Install profile marker: `/Users/mc/Repos/sf-local-logs/.claude/.gsd-profile`
Skill dirs: `/Users/mc/Repos/sf-local-logs/.claude/skills/gsd-*/`
Engine module: `/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/mc/Repos/sf-local-logs/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
